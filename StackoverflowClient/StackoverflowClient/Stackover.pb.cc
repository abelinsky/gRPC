...
// source: Stackover.proto

#include "pch.h"
#include "Stackover.pb.h"
...
static void InitDefaultsscc_info_HelloReply_Stackover_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_HelloReply_Stackover_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_HelloReply_Stackover_2eproto}, {}};

static void InitDefaultsscc_info_HelloRequest_Stackover_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_HelloRequest_Stackover_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_HelloRequest_Stackover_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_Stackover_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_Stackover_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_Stackover_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Stackover_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_Stackover_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017Stackover.proto\022\nhelloworld\"\034\n\014HelloRe"
  "quest\022\014\n\004name\030\001 \001(\t\"\035\n\nHelloReply\022\017\n\007mes"
  "sage\030\001 \001(\t2I\n\007Greeter\022>\n\010SayHello\022\030.hell"
  "oworld.HelloRequest\032\026.helloworld.HelloRe"
  "ply\"\000B\t\n\007ex.grpcb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_Stackover_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_Stackover_2eproto_sccs[2] = {
  &scc_info_HelloReply_Stackover_2eproto.base,
  &scc_info_HelloRequest_Stackover_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_Stackover_2eproto_once;
static bool descriptor_table_Stackover_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Stackover_2eproto = {
  &descriptor_table_Stackover_2eproto_initialized, descriptor_table_protodef_Stackover_2eproto, "Stackover.proto", 184,
  &descriptor_table_Stackover_2eproto_once, descriptor_table_Stackover_2eproto_sccs, descriptor_table_Stackover_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_Stackover_2eproto::offsets,
  file_level_metadata_Stackover_2eproto, 2, file_level_enum_descriptors_Stackover_2eproto, file_level_service_descriptors_Stackover_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_Stackover_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_Stackover_2eproto), true);
namespace helloworld {
...
void HelloRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_HelloRequest_Stackover_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
void HelloReply::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_HelloReply_Stackover_2eproto.base);
  message_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
